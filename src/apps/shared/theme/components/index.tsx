...
import CustomPasswordField from './PasswordField';
import CustomTextAreaField from './TextAreaField';
...
export {
    ...
    CustomPasswordField as PasswordField,
    CustomTextAreaField as TextAreaField,
};